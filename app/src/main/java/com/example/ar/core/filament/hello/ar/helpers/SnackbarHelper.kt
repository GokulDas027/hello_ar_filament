...
class SnackbarHelper {
     ...
     *
     * @param snackbarView the view to pass to [com.google.android.material.snackbar.Snackbar.make]
     * which will be used to find a suitable parent, which is a
